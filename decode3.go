...
const (
    ...
    MINLOWBITS = 3
    MINHIGHBITS = 9
    MIN_POSITIVE_PREAMBLE_SAMPLES = 40
    MIN_NEGATIVE_PREAMBLE_SAMPLES = 40
    APPROX_SAMPLES_PER_BIT =19
    FRAMEBYTECOUNT = 15
    FRAMEBITCOUNT = FRAMEBYTECOUNT*8
    SAMPLES_SIZE = FRAMEBITCOUNT*APPROX_SAMPLES_PER_BIT
    debug_level int = 4
...
func influxdb_connect() (*client.Client) {
...
func main() {
    ...
    influxdb_conn := influxdb_connect()
